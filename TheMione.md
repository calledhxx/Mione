...
即程式句開頭為HEAD的句型，其句型的功能將依據該HEAD而定，依而稱「固定開頭句」。
...
## 非固定開頭句
偽HEAD即為非HEAD開頭的類別總稱，包括SYMBOL、VARIABLE與VALUE。（Request SVV運算後的資源才可以是真正意義上的非固定開頭）
